...
// require mongoDB file connection here
require("./connection/connection-file");
// require schema file here
const StudentId = require("./schema/schema-file");
